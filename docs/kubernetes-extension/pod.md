## 목차
[1. 파드 기본 개념](#파드-기본-개념)  
[2. 파드가 필요한 이유](#파드가-필요한-이유)  
[3. 파드 내부](#파드-내부)  
[4. YAML 매니페스트 구조](#4-yam매니페스트-구조)  
[5. 파드 로그](#파드-로그)  
[6. 파드 요청(port-forward)](#파드-요청port-forward)  
[7. 파드 요청 과정](#파드-요청-과정)  
[8. 레이블](#레이블)  
[9. 레이블 셀렉터](#레이블-셀렉터)  
[10. 네임스페이스](#네임스페이스)  
[11. 네임스페이스 생성](#네임스페이스-생성)  
[12. 파드 삭제](#파드-삭제)  
[13. 초기화 컨테이너](#초기화-컨테이너)  
[14. 초기화 컨테이너 다양한 케이스](#초기화-컨테이너-다양한-케이스)  
[15. 컨테이너 리소스 제한](#컨테이너-리소스-제한)  
[16. 어노테이션](#어노테이션)  
[17. Known Labels](#known-labels)  
[18. ImagePullPolicy](#imagepullpolicy)  
[19. kubectl get](#kubectl-get)  
[20. 라이브니스 프로브](#라이브니스-프로브)  
[21. 레디니스 프로브](#레디니스-프로브)  
[22. Kubeconfig](#kubeconfig)  
[23. 컨테이너 상태](#컨테이너-상태)  
[24. 컨테이너 라이프사이클 훅](#컨테이너-라이프사이클-훅)  
[25. 쿠버네티스에서 리소스를 관리하는 방법](#쿠버네티스에서-리소스를-관리하는-방법)  
[26. cgroup v2](#cgroup-v2)  
[27. LimitRange](#limitrange)  
[28. 파드 상태](#파드-상태)  
[29. 파드 컨디션](#파드-컨디션)  
